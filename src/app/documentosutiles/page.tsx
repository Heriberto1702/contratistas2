    ...
    <>
      ...
      >
        <Modulov2
          ...
          imageUrl="/doc1.png"
          text="Este archivo le ayudará a crear el presupuesto de la obra de forma correcta y clara para presentar a su cliente. * Archivo con formato referencial. Este documento en ninguna circunstancia tiene carácter legal."
        ...
        <Modulov2
          imageUrl="/doc2.png"
          text="Utilice este archivo para calcular de manera concisa cual será el costo para usted de algún proyecto a realizar, en este podrá separar los gastos por categorías como: insumos, mano de obra, comida, traslados, entre otros, para visibilizar todos los gastos que conlleva el proyecto. * Archivo con formato referencial. Este documento en ninguna circunstancia tiene carácter legal."
          urlPDF="/doc/ejemplo.pdf"
          urlExcel="/doc/ejemplo.xlsx"
          urlExample="/doc/ejemplo.pdf"
        ...
        <Modulov2
          ...
          urlExcel="/doc/ejemplo.xlsx"
          urlExample="/doc/ejemplo.pdf"
          linkText="planificacion de proyectos >"
        />
      </Container>
      <Container
        displayType="flex"
